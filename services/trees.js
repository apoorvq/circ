...
const getBalance = async (payload) => {
  const { address1, address2, address3, address4 } = payload;
  ...
  return { doc: { address1Bal, address2Bal, address3Bal, address4Bal } };
};

const getCirculatingSupply = 
async () => {
  const { doc } = await getBalance({address1: '0x0274530AF75c489aEa7242eB72E8185E96A89f5c', address2: '0x98B58134671b9219B461dD02191585F65753972e', address3: '0x2104B45Cb222b7Bd27D3c39c4e98e9A47E5704a1', address4: '0xf9892C4A9df295c3961c61Ffc0CF806f4DF11253'});

  const circulatingSupply = 5000-doc.address1Bal-doc.address2Bal-doc.address3Bal-doc.address4Bal;
